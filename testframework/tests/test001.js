describe('Task 1 - Search Static Data', function(){
    ...
    var taskDesc = '<p>Modify <code>ImageFinder.search()</code> to search the title field of items in the global variable <code>window.data.staticImagesData</code>. You may view the data in "static-images-db.js"</p>' +
                   ...
                   '            url: "http://static.wixstatic.com/media/9f980c8bd27279a71406c1bb10916190.wix_mp", <br/>' +
                   '            title: "veggies" <br/>' +
                   '        }, <br/>' +
                   '        { <br/>' +
                   '            id: "PxtCbLD6RKrRyGGyKdwJ5w--a", <br/>' +
                   '            url: "http://static.wixstatic.com/media/a0cb4084e9c514ae7ca42143fbedf84a.wix_mp", <br/>' +
                   '            title: "veggies 2" <br/>' +
                   '        } <br/>' +
                   '    ] <br/>' +
                   '}' +
